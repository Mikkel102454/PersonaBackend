...
public record GraphMutationOperation(
    ...
    public enum Type {
        ...
        BREAK_ALL_LINKS, MOVE_LINKS, REPLACE_NODE, RENAME_NODE, CONNECT_WITH_AUTOCAST,
        ADD_VARIABLE, RENAME_VARIABLE, DELETE_VARIABLE, CHANGE_VARIABLE_TYPE, PROMOTE_TO_VARIABLE
    }
